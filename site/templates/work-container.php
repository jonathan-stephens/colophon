...
<article class="article post h-entry wrapper" itemscope itemtype="http://schema.org/Article">
  ...
  <section class="selected-work">
    <h2>Selected Work</h2>
    <p style="--measure:72ch;font-size:var(--nutgraf-secondary);max-width:var(--measure);">I've built a diverse career over 18 years—from hands-on design work to leading organizations of over 100 people. This showcase focuses <em>(mostly)</em> on the last few years of my independent practice—running my studio and taking on select freelance and consulting projects.</p>
